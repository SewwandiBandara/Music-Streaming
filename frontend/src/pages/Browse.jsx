  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-4xl font-bold text-blue-900 mb-8">{t('browse.title')}</h1>
        ...
        <div className="mt-16">
          <h2 className="text-3xl font-bold text-blue-900 mb-6">{t('browse.categories')}</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((i) => (
              <div key={i} className="bg-white rounded-lg shadow-lg p-4 hover:shadow-xl transition-shadow duration-200 border border-gray-200">
                <div className="w-full aspect-square bg-gradient-to-br from-blue-800 to-blue-900 rounded-lg mb-4"></div>
