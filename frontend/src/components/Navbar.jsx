          ...
          <div className="md:hidden pb-4 space-y-2 animate-fadeIn">
            ...
            <div className="pt-3 space-y-2 border-t border-gray-700">
              <Link
                to="/signin"
                onClick={() => setIsMenuOpen(false)}
                className="block w-full px-4 py-2 rounded-lg font-medium text-gray-200 hover:bg-gray-800 hover:text-white transition-all duration-200 text-center"
              >
                Log In
              </Link>
              <Link
                to="/signup"
                onClick={() => setIsMenuOpen(false)}
                className="block w-full px-4 py-2 rounded-lg font-semibold bg-white text-blue-900 hover:bg-gray-100 transition-all duration-200 text-center"
              >
                Sign Up
              </Link>
            </div>
